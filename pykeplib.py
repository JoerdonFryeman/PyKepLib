    ...
    def coding(self, text) -> str:
        ...
        try:
            ...
            for i in self._split_text(str(text)):
                transfer_first.append(self._coding_dict_first()[i])
            for i in self._split_text(''.join(transfer_first)):
                transfer_second.append(self._coding_dict_second()[i])
    ...
    def decoding(self, code) -> str:
        ...
        try:
            ...
            for i in transfer_first:
                transfer_second.append(self._decoding_dict_first()[i])
            for i in transfer_second:
                transfer_third.append(self._decoding_dict_second()[i])
